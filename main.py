...
def run(log_lines, total_lines, ip_location_cache, ip_datas, bad_lines):
    for line_number,line in enumerate(tqdm(log_lines,  desc="Processing log lines"), start=1):
        ...
        if line_number % 1000 == 0:
            save_ip_data_to_file('/home/aysenur/projects/nginx_analyzer/ip_datas_real_dynamic.json', ip_datas)
